    ...
    <div class="hero is-white">
        <div class="hero-body">
            <div class="container has-text-centered">
                ...
                <p class="subtitle is-3">Layanan yang bisa anda gunakan di Uranus</p>
            </div>
        </div>
    </div>
    ...
    <div class="section is-medium">
        <div class="container">
            <div class="columns is-vcentered side-feature">
                <div class="column is-5 is-hidden-desktop is-hidden-tablet">
                    <figure class="image is-1by1">
                        <img src="@/assets/images/undraw_Group_chat_unwm.svg" alt="">
                    </figure>
                </div>
            ...
            <div class="columns is-vcentered side-feature">
                <div class="column is-5 is-hidden-desktop is-hidden-tablet">
                    <figure class="image is-1by1">
                        <img src="@/assets/images/undraw_segmentation_uioo.svg" alt="">
                    </figure>
                </div>
                <div class="column is-5 is-hidden-mobile">
                    <figure class="image is-5by4">
