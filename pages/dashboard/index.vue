                ...
                <div class="column is-6 is-offset-3">
                    ...
                    <div class="box">
                        <h3 class="subtitle is-4">Proyek Terbaru</h3>
                            ...
                            <div v-for="item in 5" :key="item" class="notification">
                                <a :href="'/dashboard/investasiku/proyek/' + item">
                        ...
                        <div class="field">
                            <div class="control">
                                <a href="/dashboard/investasiku/proyek" class="button is-primary is-fullwidth">Lihat Semua</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <h3 class="subtitle is-4">Saham Terbaru</h3>
                            ...
                            <div v-for="item in 5" :key="item" class="notification">
                                <a :href="'/dashboard/investasiku/saham/' + item">
                        ...
                        <div class="field">
                            <div class="control">
                                <a href="/dashboard/investasiku/saham" class="button is-primary is-fullwidth">Lihat Semua</a>
                            </div>
                        </div>
                    </div>
                </div>
