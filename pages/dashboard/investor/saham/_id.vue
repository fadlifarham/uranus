        ...
        <div class="container">
            <div class="columns">
                ...
                <div class="column is-8">
                    ...
                    <div class="field">
                        <div class="control">
                            <button class="button is-primary is-fullwidth" @click="modalFormInvestasi = true">Investasi Sekarang</button>
                        </div>
                    </div>
                                  ...
                                  <i class="fas fa-money-bill"></i>
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <div class="columns">
                                                <div class="column">
                                                    <button @click="submitInvest()" class="button is-primary is-fullwidth">Mulai Investasi</button>
                                                </div>
                                                <div class="column">
                                                    <button class="button is-danger is-fullwidth" v-on:click="modalFormInvestasi = false">Batal</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
