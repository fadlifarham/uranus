	...
	<div class="section">
            ...
            <div class="columns">
                <div class="column is-6 is-offset-3">
                    ...
                    <div class="box">
                        <h3 class="subtitle is-4">Proyek Terbaru</h3>
                            ...
                            <div v-for="item in proyeks" :key="item.id" class="notification">
                                ...
                                <br>
                                Dibutuhkan {{ item.target }} - Imbal Balik 12%
                                <br>
                    ...
                    <div class="box">
                        ...
                        <div class="field">
                            <div class="control">
                                <a href="/dashboard/investor/investasiku/saham" class="button is-primary is-fullwidth">Lihat Semua</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="section">
            ...
            <div class="notification is-warning">
                <p>
                    Sebagai member Uranus, Anda harus menjalani proses verifikasi data untuk memastikan bahwa identitas Anda adalah benar dan sah. <br>
...
export default {
	...
	methods: {
		...
		getProyek() {
			this.$axios.get('/core/projects/?expand=company&ordering=-created_at&limit=3').then( response => {
				this.proyeks = response.data.results
            })
        },
        getCompanies() {
            this.$axios.get('/core/companies/?ordering=-created_at&limit=3').then(response => {
