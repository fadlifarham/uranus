    ...
    <div class="hero is-fullwidth is-medium is-white">
            ...
            <div class="container">
                <div class="columns is-vcentered hero-caption">
                    <div class="column is-5 is-offset-1">
                        <img src="@/assets/images/icon-hero-depan.svg">
                    </div>
                    <div class="column is-5 is-offset-1">
        ...
        <div class="container">
            <div class="tabs is-centered">
                <ul>
                    <li><img src="@/assets/images/partners/gutwork.svg" alt=""></li>
            ...
            <div class="columns is-vcentered side-feature">
                <div class="column is-5 is-hidden-desktop is-hidden-tablet">
                    <figure class="image is-1by1">
                        <!-- <img src="@/assets/images/illustration_anak_kecil.png" alt=""> -->
                    </figure>
                </div>
                <div class="column is-7">
                    <h3 class="title is-2 is-bold is-title-reveal has-text-primary">Apa itu Uranus?</h3>
                    <p class="subtitle">Uranus Adalah Platform Urun Dana untuk Ekspansi Bisnis UMKM di Indonesia.</p>
                </div>
                <div class="column is-5 is-hidden-mobile">
                    <figure class="image is-5by4">
                        <img src="@/assets/images/undraw_Savings_dwkw.svg" alt="">
                    </figure>
                </div>
            </div>
        </div>
