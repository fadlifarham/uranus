  ...
  <div class="is-fullpage has-content-centered">
    <div class="columns is-marginless is-fullpage">
        <div class="column is-half-tablet is-7-desktop is-8-widescreen is-hidden-mobile has-padding-large"
             data-background="https://demo.creativebulma.net/templates/html/pegasus/assets/images/undraw_nature_fun_n9lv.svg" style="background: url('https://www.ukmindonesia.id/assets/uploads/cover_image/ee389f4409dca5fabaaf0ad105406799.jpg/r/x1024x,,q80-.jpg.pagespeed.ic.-aZXchQpnE.jpg')  no-repeat center center fixed; background-size: cover;">
        ...
        <div class="column has-content-vspaced has-padding-large has-background-white">
            <div>
                ...
                <p class="subtitle has-text-centered has-text-weight-light">
                    atau <a href="/register">Buat Akun</a>
                </p>
            </div>
                ...
                <div class="column is-10-mobile is-8-fullhd">
                    <form class="" method="post" action="">
                        ...
                        <div class="has-text-centered">
                            <a class="title is-7 has-text-grey"
...
export default {
  head: {
    script: [
      { src: "https://use.fontawesome.com/releases/v5.0.4/js/all.js", defer: true },
...
<style scoped>
  figure {
      overflow: hidden;
      box-shadow: 0 20px 60px -2px rgba(27, 33, 58, 0.1);
  }
  ...
  figure.has-hover figcaption::after,
  figure.has-hover figcaption::before {
      position: absolute;
      content: '';
      opacity: 0;
      z-index: 1;
  ...
  figure.has-hover:hover figcaption::after,
  figure.has-hover:hover figcaption::before {
      opacity: 1;
      -webkit-transform: scale(1);
      transform: scale(1)
  }

  figure.has-hover:hover .description {
      opacity: 1;
  ...
  *, ::after, ::before {
  ...
  .box {
      background-color: #fff;
      border-radius: 6px;
      box-shadow: 0 20px 60px -2px rgba(27, 33, 58, .1);
      color: #4a4a4a;
      display: block;
      padding: 1.25rem
  }
  ...
  .is-primary.input:active, .is-primary.input:focus, .is-primary.is-active.input, .is-primary.is-active.textarea, .is-primary.is-focused.input, .is-primary.is-focused.textarea, .is-primary.textarea:active, .is-primary.textarea:focus {
      box-shadow: 0 rgba(0, 209, 178, .25)
  }
  ...
  .is-link.input:active, .is-link.input:focus, .is-link.is-active.input, .is-link.is-active.textarea, .is-link.is-focused.input, .is-link.is-focused.textarea, .is-link.textarea:active, .is-link.textarea:focus {
      box-shadow: 0 rgba(50, 115, 220, .25)
  }
  ...
  .control.has-addons, .label.has-addons {
      display: flex;
      justify-content: space-between;
      align-items: center
  }
  ...
  .input.is-outlined.is-active, .input.is-outlined.is-focused, .input.is-outlined:active, .input.is-outlined:focus {
      border-color: #f5f5f5;
      box-shadow: 0 transparent
  }

  .input.is-outlined::-moz-placeholder {
      color: #f5f5f5 !important
  }

  .input.is-outlined::-webkit-input-placeholder {
      color: #f5f5f5 !important
  }
  ...
  .input.is-outlined:-ms-input-placeholder {
      color: #f5f5f5 !important
  }

  .input.is-outlined.is-white::-moz-placeholder {
      color: #fff !important
  }

  .input.is-outlined.is-white::-webkit-input-placeholder {
      color: #fff !important
  }
  ...
  .input.is-outlined.is-white:-ms-input-placeholder {
      color: #fff !important
  }

  .input.is-outlined.is-black::-moz-placeholder {
      color: #0a0a0a !important
  }

  .input.is-outlined.is-black::-webkit-input-placeholder {
      color: #0a0a0a !important
  }
  ...
  .input.is-outlined.is-black:-ms-input-placeholder {
      color: #0a0a0a !important
  }

  .input.is-outlined.is-light::-moz-placeholder {
      color: #f5f5f5 !important
  }

  .input.is-outlined.is-light::-webkit-input-placeholder {
      color: #f5f5f5 !important
  }
  ...
  .input.is-outlined.is-light:-ms-input-placeholder {
      color: #f5f5f5 !important
  }

  .input.is-outlined.is-dark::-moz-placeholder {
      color: #363636 !important
  }

  .input.is-outlined.is-dark::-webkit-input-placeholder {
      color: #363636 !important
  }
  ...
  .input.is-outlined.is-dark:-ms-input-placeholder {
      color: #363636 !important
  }

  .input.is-outlined.is-primary::-moz-placeholder {
      color: #00d1b2 !important
  }

  .input.is-outlined.is-primary::-webkit-input-placeholder {
      color: #00d1b2 !important
  }
  ...
  .input.is-outlined.is-primary:-ms-input-placeholder {
      color: #00d1b2 !important
  }

  .input.is-outlined.is-link::-moz-placeholder {
      color: #3273dc !important
  }

  .input.is-outlined.is-link::-webkit-input-placeholder {
      color: #3273dc !important
  }
  ...
  .input.is-outlined.is-link:-ms-input-placeholder {
      color: #3273dc !important
  }

  .input.is-outlined.is-info::-moz-placeholder {
      color: #209cee !important
  }

  .input.is-outlined.is-info::-webkit-input-placeholder {
      color: #209cee !important
  }
  ...
  .input.is-outlined.is-info:-ms-input-placeholder {
      color: #209cee !important
  }

  .input.is-outlined.is-success::-moz-placeholder {
      color: #23d160 !important
  }

  .input.is-outlined.is-success::-webkit-input-placeholder {
      color: #23d160 !important
  }
  ...
  .input.is-outlined.is-success:-ms-input-placeholder {
      color: #23d160 !important
  }

  .input.is-outlined.is-warning::-moz-placeholder {
      color: #ffdd57 !important
  }

  .input.is-outlined.is-warning::-webkit-input-placeholder {
      color: #ffdd57 !important
  }
  ...
  .input.is-outlined.is-warning:-ms-input-placeholder {
      color: #ffdd57 !important
  }

  .input.is-outlined.is-danger::-moz-placeholder {
      color: #ff3860 !important
  }

  .input.is-outlined.is-danger::-webkit-input-placeholder {
      color: #ff3860 !important
  }
  ...
  .input.is-outlined.is-danger:-ms-input-placeholder {
      color: #ff3860 !important
  }
  ...
  .input.is-muted.is-active, .input.is-muted.is-focused, .input.is-muted:active, .input.is-muted:focus {
      background-color: #fff;
      border-color: #9c9c9c;
      color: #9c9c9c
  }
  ...
  .has-content-centered.is-flex-row {
      align-items: center
  }

  .has-content-vcentered:not(.is-flex-row) {
      align-items: center
  }

  .has-content-vcentered.is-flex-row {
      justify-content: center
  }
